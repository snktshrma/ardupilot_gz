...
from launch.actions import DeclareLaunchArgument, OpaqueFunction, LogInfo, IncludeLaunchDescription, RegisterEventHandler, SetEnvironmentVariable
...
def launch_state_pub_with_bridge(context):
    ...
    sdf_file = os.path.join(
        pkg_ardupilot_gz_description, "models", "iris_with_arm", "model.sdf"
    )
...
def generate_launch_description():
    ...
    ld.add_action(SetEnvironmentVariable("GZ_SIM_RESOURCE_PATH", gz_sim_resource_path))
